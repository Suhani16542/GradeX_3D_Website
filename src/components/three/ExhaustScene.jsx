 ...
 */
export function ExhaustScene({ progress = 0, mouse = { x: 0, y: 0 }, robotZ = 0, isCleaning = true, isMoving = true }) {
  return (
    <>
      {/* Deep industrial duct background & depth fog */}
      <color attach="background" args={['#050D1A']} />
      <fogExp2 attach="fog" args={['#050D1A', 0.016]} />

      {/* Cinematic Camera */}
      <HeroCamera progress={progress} mouse={mouse} robotZ={robotZ} />
